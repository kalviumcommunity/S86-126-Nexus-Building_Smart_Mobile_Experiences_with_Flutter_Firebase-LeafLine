...
### Steps Followed
- Installed Flutter SDK and added it to system PATH
- Verified setup using `flutter doctor`
- Installed Android Studio and required SDK components
- Created and launched Android Emulator
- Successfully ran Flutter apps on emulator
...
#### First Flutter App Running on Emulator
![Flutter App](screenshots/flutter_first_app.png)
